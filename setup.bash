...
which yum &> /dev/null && installer="sudo yum -y install" && upgrade="sudo yum -y upgrade"

#&& sudo rpm -Uvh http://download.fedoraproject.org/pub/epel/6/i386/epel-release-6-8.noarch.rpm &> /dev/null; sudo rpm -ivh http://pkgs.repoforge.org/rpmforge-release/rpmforge-release-0.5.3-1.el6.rf.x86_64.rpm &> /dev/null
...
$installer vim &> /dev/null || echo "Couldn't install Vim"
